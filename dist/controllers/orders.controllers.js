...
exports.createOrderProductCtlr =
  exports.getOrdersByUserAndStatusCtlr =
  exports.getOrdersByUserCtlr =
  exports.createOrderCtlr =
    void 0
const orders_1 = require('../services/orders')
const createOrderCtlr = (req, res) =>
...
const getOrdersByUserCtlr = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const userId = +req.params.id
...
const getOrdersByUserAndStatusCtlr = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const userId = +req.params.id
...
const createOrderProductCtlr = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const orderProduct = req.body
    const createdOrderProduct = yield (0, orders_1.createOrderProduct)(orderProduct)
    return res
      .status(201)
      .json({ message: 'successfully created order product', code: 201, error: null, data: createdOrderProduct })
  })
